...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem() {
    AutoBuilder.configureHolonomic(
            ...
            (ChassisSpeeds speed)->drive(speed, false), // Method that will drive the robot given ROBOT RELATIVE ChassisSpeeds
  ...
  public void simulationPeriodic() {
    ...
    swerveSimPose =
            swerveSimPose.transformBy(
                    new Transform2d(
                            new Translation2d(
                                    swerveSimTwist.dx * periodicDeltaTime, swerveSimTwist.dy * periodicDeltaTime),
  ...
  public Pose2d getPose() {
    if (Robot.isReal()) return m_odometry.getPoseMeters();
    else return swerveSimPose;
  }
  public ChassisSpeeds getTwist(boolean fieldRelative) {
    return fieldRelative?curFieldRelativeChassisSpeeds:ChassisSpeeds.fromFieldRelativeSpeeds(curFieldRelativeChassisSpeeds, m_gyro.getRotation2d());
  }
